...
<body>
    ...
    <div class="left">
        <div class="img-container">
            <img src="../img/sos.jpg" alt="couverture album sos" role="img">
    ...
    <div class="player">
        <div id="conceited">
        <audio src="songs/conceited.mp3" type="audio/mp3" controls></audio>
    </div>
    </div>
    <div class="right">
        <h2>Conceited</h2>
    ...
    <div class="player">
        <div id="ihateyou">
        <audio src="songs/ihateyou.mp3" type="audio/mp3" controls></audio>
    </div>
    </div>
    <div class="right">
        <h2>I hate you</h2>
