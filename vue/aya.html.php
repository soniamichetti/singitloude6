...
<body>
    ...
    <div class="left">
        <div class="img-container">
            <img src="../img/nakamura.jpg" alt="Couverture album nakamura" role="img">
    ...
    <div class="player">
        <div id="copines">
        <audio src="songs/copines.mp3" type="audio/mp3" controls></audio>
    </div>
    </div>
    <div class="right">
        <h2>Copines</h2>
    ...
    <div class="player">
        <div id="djadja">
        <audio src="songs/djadja.mp3" type="audio/mp3" controls></audio>
    </div>
    </div>
    <div class="right">
        <h2>Djadja</h2>
